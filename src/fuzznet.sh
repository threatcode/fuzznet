...
#echo -e        "$red                                 |$colorbase https://github.com/threatcode/FuzzNet$red |"
...
do
	if [[ $rate -gt 119 && $rate -lt 30001 ]];
		then
echo -e "The rate value is set $rate $green"
echo ""
...
cat open3389                         
echo ""
echo -e "$red Hosts with an open RDP port are recorded in a file $PWD/open3389"
sleep 2
clear
echo -e "$red---------------------------------------------------------------------------------------------------------$colorbase"
echo -e "$aquamarine                                    Let's start brute force login/password"
echo -e "$red---------------------------------------------------------------------------------------------------------$colorbase"
...
cat open3389
echo ""
echo -e "$green*Hosts with an open RDP port are recorded in a file $red $PWD/open3389 $colorbase"
